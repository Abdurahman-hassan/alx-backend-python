...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_url(self):
        """Tests Case client.GithubOrgClient.org property
        """
    ...
    def test_public_repos(self, mock_get_json):
        """Tests case for public_repos method of GithubOrgClient class
        """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """Integration test for GithubOrgClient class with parameterized
    """
    ...
    def test_requests_get_with_side_effect(self):
        """Tests case for  requests.get with side_effect method
        """
    ...
    def test_public_repos(self):
        """Tests cases for public_repos method of GithubOrgClient class
        """
        self.mock_get.return_value.json.side_effect = [
            self.org_payload,
            self.repos_payload,
    ...
    def test_public_repos_with_license(self):
        """Test public_repos with license method of GithubOrgClient class
        """
        self.mock_get.return_value.json.side_effect = [
            self.org_payload,
            self.repos_payload,
